...
- 1) MODEL E ATRIBUTOS, SERIALIZABLE, @ID, @ENTITY, @GENERATEDVALUE, @COLUMN, @MANYTOMANY, @MANYTOONE, @ONETOMANY, @JSONIGNORE, @JSONIGNOREPROPERTIES, GETTERS E SETTERS

- 2) CRIAR O SEGUNDO MODELO, NÃO ESQUECER DOS GETTERS E SETTERS LIGANDO OS MODELOS

- 3) LIGAR OS MODELOS USANDO @MANYTOMANY, @MANYTOONE, @ONETOMANY -> MAPPEDBY, @JSONIGNORE, @JSONIGNOREPROPERTIES, GENERATIONTYPE.IDENTITY, @GENERATEDVALUE, @COLUMN, @ID, CASCADETYPE.ALL

- 4) SEMPRE LER DA DIREITA PRA ESQUERDA NOS ONE TO MANY E MANY TO ONE

- 5) DEPOIS DE CRIAR OS MODELOS, CRIAR O REPOSITORY EXTENDENDO DE JPA REPOSITORY, BATE NO BANCO

- 6) CRIAR O SERVICE, FAZER A LÓGICA DOS MÉTODOS, CHAMAR O REPOSITORY COM @AUTOWIRED

- 7) CRIAR O CONTROLLER, FAZER A LÓGICA DOS MÉTODOS, CHAMAR O SERVICE

- 8) FAZER AS REQUISIÇÕES NO POSTMAN



## IMPORTANTE
- SEMPRE LEMBRAR DE LIGAR O XAMPP ANTES DE INICIAR O PROJETO
- SEMPRE LEMBRAR DE LIGAR O BANCO DE DADOS NO INTELLIJ
- SEMPRE CONFERIR AS ANOTAÇÕES E IMPORTAÇÕES
- REPOSITORY EXTENDENDO O JPA REPOSITORY
- MODEL IMPLEMENTA O SERIALIZABLE
- CONFERIR OS @Autowired, @SERVICE, @ID, @ENTITY, @GETMAPPING, @POSTMAPPING, @DELETEMAPPING, @PUTMAPPING, @REQUESTBODY, @RESPONSEENTITY, @MANYTOMANY, @MANYTOONE, @ONETOMANY, @JSONIGNORE, @JSONIGNOREPROPERTIES, @GENERATEDVALUE, @COLUMN, @PATHVARIABLE, @REQUESTBODY, @RESPONSEENTITY.
